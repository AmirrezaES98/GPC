function gamma_effect(setup)
%effect of different gamma
gamma =[0.02 0.04 0.06 0.08];
yl = cell(1,length(gamma));
xl = cell(1,length(gamma));
ynl = cell(1,length(gamma));
xnl = cell(1,length(gamma));
ul = cell(1,length(gamma));
unl = cell(1,length(gamma));

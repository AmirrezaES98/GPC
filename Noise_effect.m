...
legend('Linear Model', 'Reference', 'FontSize', 14, 'Location', 'best',Interpreter='latex')
...
xlabel('Time (sec)', 'FontSize', 18, 'FontWeight', 'bold',Interpreter='latex')
ylabel('System Response', 'FontSize', 18, 'FontWeight', 'bold',Interpreter='latex')
legend('Nonlinear Model', 'Reference','FontSize', 14, 'Location', 'best',Interpreter='latex')
